...
/**
 * Servlet implementation class ExcluirImovelServlet
 */
public class ExcluirImovelServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{
			if(imovelDAO.excluirImovel(recebeId)){
			RequestDispatcher direcionar = request.getRequestDispatcher("ListarImovel");
